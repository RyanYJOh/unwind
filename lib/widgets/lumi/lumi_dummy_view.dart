...
/// §7 Lumi 뷰 (CustomPainter 더미 렌더러).
/// 렌더러 스위치(lumi_view.dart)에서 Rive 실패 폴백 및 비교용으로 사용.
///
/// §7.3 행동 규칙 / §1.3 금지: 원망·실망 표현 없음. 졸림·기다림·안도만.
class LumiDummyView extends StatefulWidget {
...
class _LumiDummyViewState extends State<LumiDummyView> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(LumiDummyView old) {
